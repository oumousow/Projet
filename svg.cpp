...
/// Effets "Boule en relief", voir donnÈes ‡ la fin de ce fichier
...
m_filename{_filename}, m_width{_width}, m_height{_height}
{
    ...
    /// Horrible bricolage : ces donnÈes devraient soit Ítre dans un fichier auxiliaire
    /// ( c'Ètait l'approche initiale qui marchait bien sur Firefox mais pas sur les autres )
    /// soit gÈnÈrÈes dynamiquement en fonction des besoins (couleurs paramÈtrables...)
